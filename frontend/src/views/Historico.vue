                                    ...
                                    <v-card>
                                        ...
                                        <v-card-text>
                                            <v-container>
                                                ...
                                                <v-row>
                                                    <v-col cols="12" sm="6">
                                                        <v-text-field outlined v-model="itemEdicao.nome" label="Nome"
                                                            hide-details></v-text-field>
                                                    </v-col>

                                                    <v-col cols="12" sm="6">
                                                        <v-text-field outlined v-model="itemEdicao.valor" label="Valor"
                                                            hide-details></v-text-field>
                                                    </v-col>

                                                    <v-col cols="12" sm="6">
                                                        <v-select :items="tipo" label="Tipo" v-model="itemEdicao.tipo"
                                                    ...
                                                    <v-col cols="12" sm="6">
                                                        <v-menu ref="menuDataDialog" v-model="menuDataDialog"
                                                            ...
                                                            <template v-slot:activator="{ on }">
                                                                <v-text-field v-model="dataFormatada" label="Data"
                                                                    prepend-icon="mdi-calendar" outlined readonly v-on="on"
                                                                    hide-details></v-text-field>
                                                            </template>
                                                            <v-date-picker v-model="itemEdicao.data" no-title
                                                                @input="formatarData"></v-date-picker>
                                                        </v-menu>
                                                    ...
                                                    <v-col cols="12" sm="8">
                                                        <v-select :items="categorias" label="Categoria"
                                                            v-model="itemEdicao.categoria" outlined hide-details></v-select>
                                                    </v-col>
                                                                    ...
                                                                    <v-container>
                                                                        ...
                                                                        <v-row>
                                                                            ...
                                                                            <v-row>
                                                                                <v-col cols="12">
                                                                                    <v-textarea outlined
                                                                                        v-model="categoriaEdicao.descricao"
                                                                                        label="Descrição"
                                                    ...
                                                    <v-row>
                                                        <v-col cols="12">
                                                            <v-textarea outlined label="Observações"
                                                                v-model="itemEdicao.observacao" hide-details></v-textarea>
                                                        </v-col>
                                                    </v-row>
                            ...
                            <v-card>
                                ...
                                <v-card-text>
                                    <v-container>
                                        ...
                                        <v-row>
                                            <v-col cols="12" sm="12">
                                                <v-text-field outlined v-model="categoriaEdicao.nome"
                                                    label="Nome"></v-text-field>
                                            </v-col>
                                            ...
                                            <v-row>
                                                <v-col cols="12">
                                                    <v-textarea outlined v-model="categoriaEdicao.descricao"
                                                        label="Descrição" hide-details></v-textarea>
                                                </v-col>
                                            </v-row>
